...
const icons: Record<string, ReactNode> = {
  ...
  Loans: <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h16v4H4V5Zm0 6h16v8H4v-8Zm3 2v4h4v-4H7Zm7 0v2h3v-2h-3Z" /></svg>,
  "Net Worth": <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 19h16v2H4v-2Zm1-3 4-5 3 3 5-7 2 1.4-6.4 9-3.4-3.4L6.6 17.2 5 16Z" /></svg>,
